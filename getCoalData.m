...
% N(t) based on input function and ids

% Assumptions and Modifications
% - the cases must match parametric function
% - assumes either rejection sampling or time rescaling

%% Main function to get coalescent data for various functions
function [twait, tcoal] = getCoalData(fn)

% Get tree parameter data from structure
fac = fn.fac;
x = fn.param;
n = fn.nData + 1;

% Get demographic function id
fnid = fn.id;
